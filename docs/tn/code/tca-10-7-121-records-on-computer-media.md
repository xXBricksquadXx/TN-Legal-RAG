---
title: 'T.C.A. § 10-7-121 — Government records kept on computer or removable computer storage media'
jurisdiction: 'TN'
topic: 'code'
source_url: ''
citation: 'Tenn. Code Ann. § 10-7-121'
doc_id: 'tca-10-7-121'
...
- This is the core authority for electronic record-keeping for Tennessee government offices.
- Daily backup and off-site storage are explicitly required.
- The right of the public to obtain **paper copies** is preserved.
- Special rule for large counties: assessment data must be made available at cost within 30 days.

## Statutory text

<!-- Paste the full text of § 10-7-121 here -->
