...
# Tenn. Code Ann. § 10-7-511 — Preservation of records of permanent value

## Rule in plain English

The **state library and archives** is responsible for providing trained staff and equipment to produce and store **microfilm reproductions** of official, permanent-value bound volume records created by county and municipal governments, including a security microfilming program and storage of camera negatives.
...
- Priority list of essential records is based on retention schedules (CTAS / MTAS).
- Camera negatives are stored in the state library and archives security vault.
- Duplicate rolls can be provided to local governments on a cost basis.

## Example questions

- “Who is responsible for the security microfilming program for permanent-value local records?”
- “Where are the camera negatives stored under § 10-7-511?”
